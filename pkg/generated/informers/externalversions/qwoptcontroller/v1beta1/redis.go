...
import (
	"context"
	qwoptcontrollerv1beta1 "redis/pkg/apis/qwoptcontroller/v1beta1"
	versioned "redis/pkg/generated/clientset/versioned"
	internalinterfaces "redis/pkg/generated/informers/externalversions/internalinterfaces"
	v1beta1 "redis/pkg/generated/listers/qwoptcontroller/v1beta1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.QwoptcontrollerV1beta1().Redises(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.QwoptcontrollerV1beta1().Redises(namespace).Watch(context.TODO(), options)
			},
		},
		&qwoptcontrollerv1beta1.Redis{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *redisInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&qwoptcontrollerv1beta1.Redis{}, f.defaultInformer)
}
